...
class SAC(AlgoBase):
    ...
    def _update(self, batch: TransitionMiniBatch) -> Dict[str, float]:
        ...
        if isinstance(critic_loss, tuple):
            critic_loss, sharpness = critic_loss
            metrics.update({"critic_loss":critic_loss, "critic_sharpness":sharpness})
        ...
        if isinstance(actor_loss, tuple):
            actor_loss, sharpness = actor_loss
            metrics.update({"actor_loss":actor_loss, "actor_sharpness":sharpness})
